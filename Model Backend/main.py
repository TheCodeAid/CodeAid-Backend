...
def refactor_solid(files: RefactoringRequestData):
    ...
    try:
        ...
        #     refactoredCode = []
        # else:
        #     extracted_response = extract_response(refactored_files)
        #     try:
        #         validate_response(extracted_response)
        #     except:
        #         print("Failed to validate refactored main file")
        #     refactoredCode.append(extracted_response)
        #     for entry in files.data:
        #         dependencies = entry.dependencies
        #         dependency_result = solid_handler.refactorDependencyFiles(files.data[0].mainFilePath, dependencies, refactored_files)
